...
SYSTEM_INSTRUCTION = (
    "Ты — персональный ИИ-ассистент по фитнесу для мужчины 43 лет. "
    "Вес 92 кг, рост 187 см. Цель: КБЖУ 180/210/80. "
...
# --- НОВЫЙ СПОСОБ УСТАНОВКИ ВЕБХУКА ---
# Вместо before_first_request просто вызываем функцию один раз при старте
def init_webhook():
    try:
...
def start(message):
    bot.reply_to(message, "Бот готов. Жду текст или фото.")
